...
To build a class component, you would declare the component as a "class" , and state that it "extends React.Component". Before calling the render method, you create a constructor function that decalares state using "this.state". In your component's functions, it is useful to update the states. 
2. Describe the different phases of the component lifecycle.
Mounting Phase:  Inital state gets defined in your constructor function, the render method is invoked, and the "componentDidMount" method gets called.

Updating Phase: All the state and data being used in your component get updated. Then the render method gets invoked again, unless something different is specified in the "shouldComponentUpdate" method.
